...
import { NotificationRealtimeProvider } from "@/features/notifications/notification-realtime-provider";
...
export default async function AppLayout({ children, modal }: { children: ReactNode; modal?: ReactNode }) {
  ...
  return <><NotificationRealtimeProvider>
    <AppShell>{children}</AppShell>
    </NotificationRealtimeProvider>
    <AiSearchChatProvider>
      <FloatingAiButton />
      </AiSearchChatProvider>{modal ?? null}</>;
}
