...
const visuals: Record<string, { src: string; alt: string; title: string }> = {
  ...
  "/signup/account": { src: "/auth/signups2.svg", alt: "A person beginning a TalentScout account", title: "Your next opportunity starts here." },
...
export function AuthVisualPanel() {
  ...
  return (
    <aside className="relative hidden min-h-screen overflow-hidden bg-primary lg:block">
      <Image src={visual.src} alt={visual.alt} fill priority className="object-cover object-center" sizes="45vw" />
      <div className="absolute inset-0 bg-primary/20" />
      <div className="absolute inset-x-0 bottom-0 z-10 p-12 text-primary-foreground xl:p-16">
        <p className="font-display text-4xl leading-none xl:text-6xl">TalentScout</p>
