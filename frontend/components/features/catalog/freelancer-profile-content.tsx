...
export function FreelancerProfileContent({ profile, packages, freelancer: freelancerProp, mode, packagePresentation }: FreelancerProfileContentProps) {
