...
const envSchema = z.object({
  ...
  SUPABASE_FREELANCER_SAMPLE_WORK_BUCKET: z.string().trim().min(1).default('freelancer-sample-work'),
  FREELANCER_SAMPLE_WORK_MAX_BYTES: z.coerce.number().int().positive().default(10485760),
  FREELANCER_SAMPLE_WORK_SIGNED_URL_TTL_SECONDS: z.coerce.number().int().positive().default(3600),
